...
export const LANDING_PAGES = {
  practice: {
    ...
    description: `Practice CELPIP online with ${PRODUCT_STATS.questionItems} question items, section drills, mock exams, AI scoring, and saved progress for your target CLB.`,
    ...
    sections: [
      ...
      ['Writing practice', 'Email and survey prompts with instant AI feedback.'],
    ...
    faqs: [
      ['Can I take a CELPIP practice test for free?', 'Yes. CELPIPACE lets you start with free practice and then upgrade when you need full mock exams, AI scoring, and saved reports.'],
  ...
  mock: {
    ...
    description: `Take ${PRODUCT_STATS.mockExams} full-length CELPIP mock exams online with timed sections, instant scoring, AI writing and speaking feedback, and saved score reports.`,
    ...
    sections: [
      ...
      ['CLB score report', 'Review your objective scores plus AI-scored writing and speaking bands.'],
    ...
    faqs: [
      ...
      ['Does the mock test include writing and speaking?', 'Yes. CELPIPACE includes Writing and Speaking tasks with AI scoring when users submit responses for evaluation.'],
