...
export const LANDING_PAGES = {
  practice: {
    ...
    seoTitle: 'CELPIP Practice Test Online – Free Section Drills & Mock Exams',
    description: `Free CELPIP practice test online — ${PRODUCT_STATS.questionItems} questions across Listening, Reading, Writing & Speaking. Timed drills, mock exams, and instant CLB scoring.`,
  ...
  mock: {
    ...
    seoTitle: 'CELPIP Mock Test Online – Full Exam With CLB Score Report',
  ...
  comparison: {
    ...
    seoTitle: 'CELPIP vs IELTS – Which Is Easier for Canadian PR? (2026)',
  ...
  listening: {
    ...
    seoTitle: 'CELPIP Listening Practice Online – All 6 Parts Free (2026)',
  ...
  speaking: {
    ...
    seoTitle: 'CELPIP Speaking Practice – All 8 Tasks With AI Feedback',
