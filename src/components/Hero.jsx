...
// Speaking leads: it's 54% of all practice attempts and the one section
// people can't practise well without instant feedback — i.e. the reason to pay.
const SECTIONS = [
  {
    ...SECTION_LIBRARY.speaking,
    desc: `8 Tasks · ${PRODUCT_STATS.speakingPrompts} Prompts · AI-scored`,
    accent: '#C8102E',
  },
  {
        ...
        <div className="hp-hero-top">
          ...
          <div className="hp-hero-copy">
            ...
            <p className="hp-hero-desc">
              Speak to a CELPIP prompt and get a CLB score with feedback in seconds. Then
              full-length mocks, instant scoring on every section, and an AI coach that turns
              your mistakes into a weekly plan — {PRODUCT_STATS.questionItems} questions,
              {PRODUCT_STATS.mockExams} timed exams, built for Express Entry and PR.
            </p>

            <div className="hp-hero-ctas">
              <button className="btn btn-white btn-lg" onClick={() => navigate('/celpip-speaking-practice/S1')}>
                Try a speaking task
              </button>
              <button className="btn btn-ghost-white btn-lg" onClick={() => navigate('/study-coach')}>
                Meet your AI coach
              </button>
            </div>
