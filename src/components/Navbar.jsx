...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    parts: [
      ...
      { label: 'CELPIP Resources',     desc: 'Section-by-section tips and training to boost your CLB band', action: 'celpip-resources' },
...
export default function Navbar({ onSignIn }) {
  ...
  const activeId = ['celpip-resources', 'scores', 'crs-score-calculator', 'blog'].includes(currentPath) ? 'learn' : currentPath
